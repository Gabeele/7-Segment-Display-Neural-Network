...
/// Version 1.0
///
/// Single and Multilayered Perceptron neural network header file
...
public:
    ...
    //7 Segment Display Specicific methods
    double train(int epochs);
    int convert(vector<double> input);
    double outputIndex(vector<double> input);
